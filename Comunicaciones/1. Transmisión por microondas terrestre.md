...
![[AdAsimetrico.jpg]]
##### La altura en de un punto en funcion de Ad y d' queda expresada entonces de la siguiente manera:
...
En la categoría RBU entran los puntos de acceso inalambricos (popularizados como access point) que se utilizan para transmitir en 802.11 en modo infraestructura, al que apropiadamente se le puede decir que actúa como radio módem. [[5. 802.11 Wireless LAN- Virtual]]
### Los alimentadores
...
### Las antenas [[2.1 Medios de transmisión no guiados]]
